      ...
      <div className="relative mx-auto max-w-[1280px] px-5 md:px-10">
        ...
        <Reveal delay={0.15}>
          <div className="overflow-hidden rounded-3xl border border-[#e5e7eb] bg-white shadow-[0_30px_60px_-30px_rgba(15,23,42,0.15)]">
            {/* Header */}
            <div className="grid grid-cols-[1.4fr_1fr_1fr] md:grid-cols-[2fr_1fr_1fr] bg-[#F9FAFB] border-b border-[#e5e7eb]">
            ...
            <div className="divide-y divide-[#e5e7eb]">
              {rows.map((r, i) => (
                <motion.div
                  ...
                  className="grid grid-cols-[1.4fr_1fr_1fr] md:grid-cols-[2fr_1fr_1fr] hover:bg-[#F9FAFB]/50 transition-colors"
                >
            ...
            {/* Footer */}
            <div className="grid grid-cols-[1.4fr_1fr_1fr] md:grid-cols-[2fr_1fr_1fr] bg-gradient-to-r from-[#0A1426] to-[#0b1d3a] text-white">
