(function () {
  ...
  style.textContent = [
    ...
    ".fwv-greeting{position:absolute;right:68px;bottom:7px;width:205px;padding:11px 13px;border:1px solid #dfe5eb;border-radius:14px 14px 4px 14px;color:#18304b;background:#fff;box-shadow:0 14px 36px rgba(11,31,54,.18);font-size:11px;line-height:1.4}",
  ...
  greeting.innerHTML = "<strong>Bonjour! 👋</strong>French question, course guidance, or technical issue? I’m here to help.";
  ...
  window.addEventListener("message", function (event) {
    ...
    if (event.data && event.data.type === "frenchify-assistant:close") setOpen(false);
  });
  ...
  try {
    if (!window.sessionStorage.getItem("frenchify-assistant-seen")) {
